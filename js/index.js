  ...
  isMoved = false;
    ...
    components.onclick = () => {
      if (isMoved) {
        ...
        // 注意!此处我将自己尝试加入一些功能,出现bug请先删掉这一段
        // 获取具有 id 为 "nav_color" 的元素
       
        document.getElementById("shouye").style.background = "linear-gradient(to right, rgba(51, 153, 255, 0.5), rgba(138, 99, 210, 0.7))";
        //切换浅色背景
        document.body.style.backgroundImage = "url('../images/tree1.webp')";
        //草泥马,加了这段按钮就没了
        //不科学啊
        //一个标签只能有一个id,👴给整忘了
        //浅色元素颜色
        //切换浅色元素颜色
        document.getElementById("main").style.background = "linear-gradient(to bottom right, #ffffffeb, #ffffffeb)";
        document.getElementById("p").style.backgroundImage = "url('../images/triangle.png')";
        document.getElementById("square1").style.backgroundColor = "#cceeff";
        document.getElementById("square2").style.backgroundColor = "#cceeff";
        document.getElementById("square3").style.backgroundColor = "#cceeff";
        document.querySelector('.timeline-event').style.backgroundColor = "#cceeff";
        ...
        //这段也是👴加的,👴整会辣哈哈哈哈
        document.getElementById("shouye").style.background = "linear-gradient(to right, rgba(0, 31, 63, 0.5), rgba(46, 8, 84, 0.5))";
        //切换深色背景
        document.body.style.backgroundImage = "url('../images/MilkyWay.webp')";
        //切换深色元素颜色
        document.getElementById("main").style.background = "linear-gradient(to bottom right, rgba(0, 31, 63, 0.7), rgba(46, 8, 84, 0.7))";
        document.getElementById("p").style.backgroundImage = "url('../images/triangle_dark.png')";
        document.getElementById("square1").style.backgroundColor = "#305080";
        document.getElementById("square2").style.backgroundColor = "#305080";
        document.getElementById("square3").style.backgroundColor = "#305080";
